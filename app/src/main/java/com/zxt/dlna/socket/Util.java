 ...
 */
public class Util {
    private static final int PACKET_SIZE = 1024 * 20; // 每个包的大小,200首6-9个包
    public static final String HEART = "发送心跳包";
    ...
    public static QPlayTrackMetaData covertTrackData(String tracksMetaData) {
        if (tracksMetaData != null) {
            Gson gson = new Gson();
            QPlayTrackMetaData trackMetaData = gson.fromJson(tracksMetaData, QPlayTrackMetaData.class);
