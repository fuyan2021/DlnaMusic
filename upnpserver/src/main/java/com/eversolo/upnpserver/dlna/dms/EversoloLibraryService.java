...
import com.eversolo.upnpserver.dlna.util.AlbumContainer;
import com.eversolo.upnpserver.dlna.util.ApiClient;
import com.eversolo.upnpserver.dlna.util.ArtistContainer;
import com.eversolo.upnpserver.dlna.util.ComposerContainer;
import com.eversolo.upnpserver.dlna.util.FileHelper;
import com.eversolo.upnpserver.dlna.util.GenreContainer;
import com.eversolo.upnpserver.dlna.util.SingleMusicContainer;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (action) {
                case ACTION_START_SERVER:
                    Settings.System.putInt(context.getContentResolver(), CLING_SETTING_NAME, 1);
                    bootComplete();
                    break;

                case ACTION_STOP_SERVER:
                    Settings.System.putInt(context.getContentResolver(), CLING_SETTING_NAME, 0);
                    stopServer();
                    break;
